...
export const Battle: FC<BattleProps> = () => {
  const [usersOnBattle, logs, battleIds] = useUnit([
  ...
  const user1 = usersOnBattle[battleIds[curBattle][0]];
  const user2 = usersOnBattle[battleIds[curBattle][1]];
