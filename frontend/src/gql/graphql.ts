...
export type BattleLogsQuery = {
  ...
  battleLogs: Array<{
    ...
    turns: Array<{
      ...
      logs: Array<{ __typename?: "TurnLog"; action: any; character: string }>;
      character2?: {
        __typename?: "CharacterTurnState";
        energy: number;
        position: number;
...
export type BattleLogByIdQuery = {
  __typename?: "Query";
  battleLogById?: {
    __typename?: "BattleLog";
    id: string;
...
export type BattleLogsByLobbyIdQuery = {
  __typename?: "Query";
  battleLogs: Array<{ __typename?: "BattleLog"; id: string }>;
};
...
export type CharactersByOwnerQuery = {
  __typename?: "Query";
  characters: Array<{
    __typename?: "Character";
    id: string;
...
export const BattleLogsDocument = {
  kind: "Document",
  definitions: [
    {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "battleIndex" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "character1" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      {
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "character2" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      {
...
} as unknown as DocumentNode<BattleLogsQuery, BattleLogsQueryVariables>;
export const BattleLogByIdDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "BattleLogById" },
      variableDefinitions: [
        {
                    ...
                    selections: [
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "chillingTouch" },
                            },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "earthSkin" },
                            },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "earthSmites" },
                            },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "fireHaste" },
                            },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "fireWall" },
                            },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "waterBurst" },
                            },
                          ],
                        },
                      },
...
} as unknown as DocumentNode<BattleLogByIdQuery, BattleLogByIdQueryVariables>;
export const BattleLogsByLobbyIdDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "BattleLogsByLobbyId" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
} as unknown as DocumentNode<AllCharactersQuery, AllCharactersQueryVariables>;
export const CharactersByOwnerDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "CharactersByOwner" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  CharactersByOwnerQuery,
  CharactersByOwnerQueryVariables
>;
      ...
      variableDefinitions: [
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "character_id" },
          },
          type: {
            kind: "NonNullType",
            type: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "level" } },
                { kind: "Field", name: { kind: "Name", value: "owner" } },
                { kind: "Field", name: { kind: "Name", value: "livesCount" } },
                { kind: "Field", name: { kind: "Name", value: "name" } },
...
} as unknown as DocumentNode<LobbiesQuery, LobbiesQueryVariables>;
export const LobbyById2Document = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "LobbyById2" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "lobbyById" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "id" },
...
} as unknown as DocumentNode<LobbyById2Query, LobbyById2QueryVariables>;
