...
export const ErrorReplyReason: sts.Type<ErrorReplyReason> = sts.closedEnum(() => {
    return  {
        ...
        ReinstrumentationFailure: sts.unit(),
...
export type SimpleExecutionError = SimpleExecutionError_BackendError | SimpleExecutionError_MemoryOverflow | SimpleExecutionError_RanOutOfGas | SimpleExecutionError_StackLimitExceeded | SimpleExecutionError_UnreachableInstruction | SimpleExecutionError_Unsupported | SimpleExecutionError_UserspacePanic
...
export interface SimpleExecutionError_StackLimitExceeded {
...
export type ErrorReplyReason = ErrorReplyReason_Execution | ErrorReplyReason_FailedToCreateProgram | ErrorReplyReason_InactiveProgram | ErrorReplyReason_ReinstrumentationFailure | ErrorReplyReason_RemovedFromWaitlist | ErrorReplyReason_Unsupported
...
export interface ErrorReplyReason_ReinstrumentationFailure {
