...
export type LobbiesQuery = { __typename?: 'Query', lobbies: Array<{ __typename?: 'Lobby', id: string, capacity: number, reservationsCount: number, characters: Array<{ __typename?: 'LobbyCharacter', id: string, character: { __typename?: 'Character', id: string, name: string, owner: string, level: number, experience: number, attributes: any } }>, battleLogs: Array<{ __typename?: 'BattleLog', id: string }> }> };
...
export type LobbyById2Query = { __typename?: 'Query', lobbyById?: { __typename?: 'Lobby', id: string, capacity: number, reservationsCount: number, characters: Array<{ __typename?: 'LobbyCharacter', id: string, character: { __typename?: 'Character', id: string, name: string, owner: string, level: number, experience: number, attributes: any } }>, battleLogs: Array<{ __typename?: 'BattleLog', id: string }> } | null };
