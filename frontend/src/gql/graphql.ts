...
export type BattleLogByIdQuery = { __typename?: 'Query', battleLogById?: { __typename?: 'BattleLog', id: string, battleIndex: number, character1: { __typename?: 'CharacterState', winner: boolean, attributes: any, character: string, experience: number, rating: number, level: number }, character2: { __typename?: 'CharacterState', winner: boolean, attributes: any, experience: number, character: string, level: number, rating: number }, lobby: { __typename?: 'Lobby', id: string, tier: number, reservationsCount: number, capacity: number, characters: Array<{ __typename?: 'LobbyCharacter', id: string, character: { __typename?: 'Character', owner: string, name: string, level: number, experience: number, attributes: any, id: string } }> }, turns: Array<{ __typename?: 'BattleTurn', character1?: { __typename?: 'CharacterTurnState', energy: number, hp: number, position: number, chillingTouch: number, earthSkin: number, earthSmites: number, fireHaste: number, fireWall: number, waterBurst: number } | null, logs: Array<{ __typename?: 'TurnLog', action: any, character: string }>, character2?: { __typename?: 'CharacterTurnState', energy: number, position: number, hp: number, chillingTouch: number, earthSkin: number, earthSmites: number, fireHaste: number, fireWall: number, waterBurst: number } | null }> } | null };
...
export type CharacterByIdQuery = { __typename?: 'Query', characterById?: { __typename?: 'Character', attributes: any, experience: number, balance: number, id: string, level: number, owner: string, livesCount: number, name: string, rating: number } | null };
